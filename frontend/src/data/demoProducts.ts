...
export const DEMO_PRODUCTS_BY_CATEGORY: Record<string, Omit<Product, "id">[]> = {
  meat: [
    ...
    { name: "Ребрышки", seller: "Prime Meat", price: 950, rating: "4.8", reviews: 64, image: "media/card_meat2.jpg", category: "meat" },
    ...
    { name: "Оптовые поставки мяса", seller: "USC партнер", price: 0, rating: "5.0", reviews: 12, image: "media/card_meat6.jpg", category: "meat" },
  ],
  milk: [
    ...
    { name: "Молочные поставки", seller: "USC партнер", price: 0, rating: "4.9", reviews: 18, image: "media/card_milk6.jpg", category: "milk" },
  ],
  fish: [
    ...
    { name: "Оптовые морепродукты", seller: "USC партнер", price: 0, rating: "4.9", reviews: 14, image: "media/card_fish6.jpg", category: "fish" },
  ],
  bread: [
    { name: "Хлеб пшеничный", seller: "Bakery 24", price: 25, rating: "4.8", reviews: 80, image: "media/card_bread1.jpg", category: "bread" },
    { name: "Лепешка тандырная", seller: "Orient Bakery", price: 30, rating: "4.9", reviews: 67, image: "media/card_bread2.jpg", category: "bread" },
    ...
    { name: "Оптовые хлебобулочные", seller: "USC партнер", price: 0, rating: "4.8", reviews: 17, image: "media/card_bread6.jpg", category: "bread" },
  ],
  fruit: [
    ...
    { name: "Оптовые овощи и фрукты", seller: "USC партнер", price: 0, rating: "4.9", reviews: 19, image: "media/card_fruit6.jpg", category: "fruit" },
  ],
  grain: [
    ...
    { name: "Рис узбекский длиннозерный", seller: "Asia Grain", price: 70, rating: "4.7", reviews: 33, image: "media/card_grain2.jpg", category: "grain" },
    ...
    { name: "Зерновые поставки", seller: "USC партнер", price: 0, rating: "4.9", reviews: 16, image: "media/card_grain6.jpg", category: "grain" },
  ],
};
