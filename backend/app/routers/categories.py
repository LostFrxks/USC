...
def _invalidate_category_related_cache() -> None:
    invalidate_patterns("v1:categories:*", "v1:products:*", "v1:analytics:*")
...
def list_categories(
    ...
    cache_key = make_key("categories", "list", limit, offset)
    ...
    set_json(cache_key, response, settings.CACHE_TTL_CATEGORIES)
    return response
...
def create_category(
    ...
    try:
        ...
        db.commit()
        _invalidate_category_related_cache()
